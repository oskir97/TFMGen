...
public void ModifyDefault (MaterialEN material)
{
        try
        {
                ...
                materialNH.Numeroalternativoproveedor = material.Numeroalternativoproveedor;
...
public System.Collections.Generic.IList<TFMGen.ApplicationCore.EN.TFM.MaterialEN> Listar (int p_idInstalacion)
{
        ...
        {
                SessionInitializeTransaction ();
                //String sql = @"FROM MaterialNH self where SELECT m FROM MaterialNH as m WHERE m.Instalacion.Idinstalacion = :p_idInstalacion";
