...
{
public void Asignarusuario (int p_oid, TFMGen.ApplicationCore.EN.TFM.UsuarioEN usuario)
{
        ...
        try
        {
                ...
                if (eventoEN.Usuarios.Count () < eventoEN.Plazas) {
                        if (eventoEN.Usuarios.Count () == 0) {
