                        ...
                        default:
                            if (!string.IsNullOrEmpty(latitud) && !string.IsNullOrEmpty(longitud))
                            {
                                ...
                                if (double.TryParse(latitud, out latitudDouble) && double.TryParse(longitud, out longitudDouble))
                                {
                                    ...
                                    {
                                        double latitud1 = reserva.Pista.Instalacion != null ? reserva.Pista.Instalacion.Latitud : reserva.Pista.Instalacion.Latitud;
                                        double longitud1 = reserva.Pista.Instalacion != null ? reserva.Pista.Instalacion.Longitud : reserva.Pista.Instalacion.Longitud;
