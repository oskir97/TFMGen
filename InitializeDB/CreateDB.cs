...
public static void InitializeData ()
{
        try
        {
                ...
                //Reservas
                int idreserva = reservacen.Crear (usuarioEn.Nombre, usuarioEn.Apellidos, usuarioEn.Email, usuarioEn.Telefono, false, pistaLibre, 1, horario1213, Convert.ToDateTime ("13/02/2023"), TipoReservaEnum.reserva, usuarioEn.Idusuario, padel, -1, null, -1);
                int idpartido = reservacen.Crear (usuarioEn.Nombre, usuarioEn.Apellidos, usuarioEn.Email, usuarioEn.Telefono, false, pistaLibre, 4, horario1213, DateTime.Now.AddDays (8), TipoReservaEnum.partido, idadministrador, padel, -1, NivelPartidoEnum.medio, -1);
                ...
                int idreservapartido = reservacen.Crear (usuarioEn.Nombre, usuarioEn.Apellidos, usuarioEn.Email, usuarioEn.Telefono, false, pistaLibre, 4, horario1213, DateTime.Now.AddDays (7), TipoReservaEnum.partido, idadministrador, padel, -1, NivelPartidoEnum.medio, -1);
