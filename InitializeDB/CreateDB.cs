    ...
    public class CreateDB
    {
        ...
        public static void InitializeData()
        {
            try
            {
                ...
                var pavellon = instalacioncen.Crear("Complejo Deportivo Municipal Eduardo Latorre", entidadPrivada, true, 38.70514175374284, -0.4730745998107246, "659874158", "Carrer Juan Gil Albert, 6", null, "03804", "Alcoy/Alcoi", "Alicante", "698254715");
                var polideportivo2 = instalacioncen.Crear("Universidad de Alcoy EPSA", entidadPublica, true, 38.694240194850074, -0.4774155240370907, "968887541", "Plaça Ferrándiz i Carbonell, s/n", null, "03801", "Alcoy/Alcoi", "Alicante", "698572147");
                var pavellon2 = instalacioncen.Crear("Club altamira Pàdel & Fitness", entidadPrivada2, true, 38.71798605416559, -0.45675760990557196, "659874158", "Avinguda de la Serrella, s/n", null, "03804", "Alcoy/Alcoi", "Alicante", "698254715");
                ...
                horariocen.Crear(DateTime.Parse("07:00:00"), DateTime.Parse("08:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("08:00:00"), DateTime.Parse("09:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("09:00:00"), DateTime.Parse("10:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("10:00:00"), DateTime.Parse("11:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("11:00:00"), DateTime.Parse("12:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                var horario1213Pavellon2 = horariocen.Crear(DateTime.Parse("12:00:00"), DateTime.Parse("13:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("13:00:00"), DateTime.Parse("14:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("14:00:00"), DateTime.Parse("15:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("15:00:00"), DateTime.Parse("16:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("16:00:00"), DateTime.Parse("17:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes });
                int horariotardePavellon2 = horariocen.Crear(DateTime.Parse("17:00:00"), DateTime.Parse("18:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("18:00:00"), DateTime.Parse("19:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("19:00:00"), DateTime.Parse("20:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, domingo });
                horariocen.Crear(DateTime.Parse("20:00:00"), DateTime.Parse("21:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes, domingo });
                horariocen.Crear(DateTime.Parse("21:00:00"), DateTime.Parse("22:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("22:00:00"), DateTime.Parse("23:00:00"), pistaLibrePavellon2, new List<int> { lunes, martes, miercoles, jueves, viernes });

                horariocen.Crear(DateTime.Parse("07:00:00"), DateTime.Parse("08:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("08:00:00"), DateTime.Parse("09:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("09:00:00"), DateTime.Parse("10:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("10:00:00"), DateTime.Parse("11:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("11:00:00"), DateTime.Parse("12:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("12:00:00"), DateTime.Parse("13:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("13:00:00"), DateTime.Parse("14:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("14:00:00"), DateTime.Parse("15:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("15:00:00"), DateTime.Parse("16:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("16:00:00"), DateTime.Parse("17:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("17:00:00"), DateTime.Parse("18:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("18:00:00"), DateTime.Parse("19:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, sabado, domingo });
                horariocen.Crear(DateTime.Parse("19:00:00"), DateTime.Parse("20:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, domingo });
                horariocen.Crear(DateTime.Parse("20:00:00"), DateTime.Parse("21:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes, domingo });
                horariocen.Crear(DateTime.Parse("21:00:00"), DateTime.Parse("22:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes });
                horariocen.Crear(DateTime.Parse("22:00:00"), DateTime.Parse("23:00:00"), pistaLibre2Pavellon, new List<int> { lunes, martes, miercoles, jueves, viernes });
                ...
                //Reservas
                int idreserva = reservacen.Crear(usuarioEn.Nombre, usuarioEn.Apellidos, usuarioEn.Email, usuarioEn.Telefono, false, pistaLibre, 1, horario1213, Convert.ToDateTime("13/02/2023"), TipoReservaEnum.reserva, usuarioEn.Idusuario, padel, -1);
                int idpartido = reservacen.Crear(usuarioEn.Nombre, usuarioEn.Apellidos, usuarioEn.Email, usuarioEn.Telefono, false, pistaLibre, 4, horario1213, Convert.ToDateTime("13/02/2023"), TipoReservaEnum.partido, usuarioEn.Idusuario, padel, -1);
                ...
                int idreservapartido = reservacen.Crear(usuarioEn.Nombre, usuarioEn.Apellidos, usuarioEn.Email, usuarioEn.Telefono, false, pistaLibre, 1, horario1213, Convert.ToDateTime("13/02/2023"), TipoReservaEnum.reserva, usuarioEn.Idusuario, padel, -1);
                reservacp.Inscribirsepartido(idpartido, new List<int> { idreservapartido });

                //Eventos

                int eventoPadel = eventocen.Crear("Clase de padel miercoles", "Clase de pádel de los miercoles por la tarde", entidadPublica, true, 10, padel, DateTime.Now, DateTime.Now.AddYears(1), -1, 30);
