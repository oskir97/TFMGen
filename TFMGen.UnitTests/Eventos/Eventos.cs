...
namespace TFMGen.UnitTests.Eventos
{
    ...
    public class Eventos
    {
        ...
        public void CrearEvento()
        {
            ...
            int idEvento = this.db.eventocen.Crear("Nuevo evento", "Descripcion del evento", entidadEN.Identidad, true, 15, deporteEN.Iddeporte, DateTime.Now, DateTime.Now.AddYears(1), -1, 30);
