...
namespace TFMGen.UnitTests.Reservas
{
    ...
    public class Reservas
    {
        ...
        public void ReservarPista()
        {
            ...
            int Reserva = this.db.reservacen.Crear(usuario.Nombre, usuario.Apellidos, usuario.Email, usuario.Telefono, false, id_pista_creada, 5, 524293, DateTime.Now, TipoReservaEnum.reserva, usuario.Idusuario, deporteEN.Iddeporte, -1, null, -1);
        ...
        public void ReservarPistaNosesion()
        {
            ...
            int Reserva = this.db.reservacen.Crear("", "", "", "", false, id_pista_creada, 5, 524293, DateTime.Now, TipoReservaEnum.reserva, user, deporteEN.Iddeporte , -1, null, -1);
            Assert.AreNotEqual(null, this.db.reservacen.Obtener(Reserva));
        ...
        public void ReservarPistaOcupada()
        {
            ...
            int Reserva = this.db.reservacen.Crear(usuario.Nombre, usuario.Apellidos, usuario.Email, usuario.Telefono, false, id_pista_creada, 5, 524293, fecha, TipoReservaEnum.reserva, usuario.Idusuario, deporteEN.Iddeporte, -1, null, -1);
            Assert.AreNotEqual(null, this.db.reservacen.Obtener(Reserva));
