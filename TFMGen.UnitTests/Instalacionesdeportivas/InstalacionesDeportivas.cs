...
namespace TFMGen.UnitTests.Instalaciones_deportivas
{
    ...
    public class InstalacionesDeportivas
    {
        ...
        public void CrearInstalacion()
        {
            ...
            int idInstalacion = this.db.instalacioncen.Crear("Instalación de padel", entidad.Identidad,true,-0.4814900, 38.3451700, "666666666", "Calle padel", null, "03801", "Alcoy", "Alicante", null, "dasdasd@pruebas.com", null);
        ...
        {
            EntidadEN entidad = this.db.entidadcen.Listar(0, 1).First();
            int idInstalacion = this.db.instalacioncen.Crear(null, entidad.Identidad, true, -0.4814900, 38.3451700, "666666666", "Calle padel", null, "03801", "Alcoy", "Alicante", null, "dasdasd@pruebas.com", null);
        ...
        public void ModificarInstalacion()
        {
            ...
            this.db.instalacioncen.Editar(instalacionENModificado.Idinstalacion, instalacionENModificado.Nombre,
                ...
                instalacionENModificado.Codigopostal, instalacionENModificado.Localidad, instalacionENModificado.Provincia, instalacionENModificado.Telefonoalternativo, -0.4814900, 38.3451700, "dasdasd@pruebas.com", null);
