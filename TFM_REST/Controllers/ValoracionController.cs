...
namespace TFM_REST.Controllers
{
    ...
    public class ValoracionController : BasicController
    {
        ...
        public ActionResult<System.Collections.Generic.List<ValoracionDTOA>> Listar()
        {
            // CAD, CEN, EN, returnValue
            ...
            try
            {
                ...
                en = valoracionCEN.Listar(id).ToList();
        ...
        public ActionResult<System.Collections.Generic.List<ValoracionDTOA>> Listartecnico()
        {
            // CAD, CEN, EN, returnValue
            ...
            try
            {
                ...
                en = valoracionCEN.Listartecnico(id).ToList();
        ...
        // No pasa el slEnables: listarevento
        ...
        [Route("~/api/Valoracion/Valorarevento")]


        public ActionResult Valorarevento(int p_valoracion, int p_evento)
        {
            // CAD, CEN, returnValue
            ValoracionRESTCAD valoracionRESTCAD = null;
            ValoracionCEN valoracionCEN = null;
        ...
        [Route("~/api/Valoracion/Listarevento")]

        public ActionResult<System.Collections.Generic.List<ValoracionDTOA>> Listarevento(int p_idevento)
        {
            // CAD, CEN, EN, returnValue
            ...
            try
            {
                ...
                en = valoracionCEN.Listarevento(p_idevento).ToList();
