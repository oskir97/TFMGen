...
[Route ("~/api/Rol_l10n/Listartodos")]
public ActionResult<List<Rol_l10nDTOA> > Listartodos ()
{
        // CAD, CEN, EN, returnValue
        Rol_l10nRESTCAD rol_l10nRESTCAD = null;
        Rol_l10nCEN rol_l10nCEN = null;

        List<Rol_l10nEN> rol_l10nEN = null;
        List<Rol_l10nDTOA> returnValue = null;
        ...
        try
        {
                ...
                rol_l10nEN = rol_l10nCEN.Listartodos (0, -1).ToList ();

                // Convert return
                if (rol_l10nEN != null) {
                        returnValue = new List<Rol_l10nDTOA>();
                        foreach (Rol_l10nEN entry in rol_l10nEN)
